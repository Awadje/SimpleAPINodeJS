...
//MIDDLEWARE -
//Middleware can be very usefull for doing validations. We can log
//things from here or stop the request form continueing in the event
//that the request is not safe.
//middleware to use for all requests
router.use(function(req, res, next) {
  console.log('FYI... There is some processing going down..')
  next();
});
